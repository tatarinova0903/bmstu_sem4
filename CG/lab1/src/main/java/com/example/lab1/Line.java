...
public class Line {
    ...
    Line centerPerpendicular(Segment segment) {
        Point centerPoint = segment.center();
        double coefC = coefA * centerPoint.getY() - coefB * centerPoint.getX();
        return new Line(this.coefB, -this.coefA, coefC);
    }
}
