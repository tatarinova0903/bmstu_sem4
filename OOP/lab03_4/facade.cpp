...
facade::facade()
{
    _drawManager = draw_manager_creator().create_man();
    _loadManager = load_manager_cretor().create_man();
    _sceneManager = scene_manager_creator().create_man();
    _transformManager = reform_manager_creator().create_man();
}
